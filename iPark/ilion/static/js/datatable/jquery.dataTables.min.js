    ...
    (function (n) {
        ...
        function lt(n) {
            ...
            if (n.oFeatures.bAutoWidth !== !1)
                for (i = n.aoColumns, lr(n), t = 0, u = i.length; t < u; t++) i[t].nTh.style.width = i[t].sWidth;
            r = n.oScroll;
            (r.sY !== "" || r.sX !== "") && kt(n);
        ...
        function tr(n) {
            for (var h = n.aoColumns, p = n.aoData, c = u.ext.type.detect, o, a, r, y, t, e, s, f = 0, l = h.length; f < l; f++)
                if (t = h[f], s = [], !t.sType && t._sManualType) t.sType = t._sManualType;
                else if (!t.sType) {
                for (o = 0, a = c.length; o < a; o++) {
                    for (r = 0, y = p.length; r < y; r++)
                        if (s[r] === i && (s[r] = v(n, r, f, "type")), e = c[o](s[r]), !e || e === "html") break;
                    if (e) {
                        t.sType = e;
                        break
                    }
        ...
        function su(n, t, u, f) {
            ...
            if (t)
                for (s = t.length - 1; s >= 0; s--)
                    for (h = t[s], e = h.targets !== i ? h.targets : h.aTargets, r.isArray(e) || (e = [e]), o = 0, a = e.length; o < a; o++)
                ...
                for (c = 0, v = n.aoColumns.length; c < v; c++)(e[o] == "_all" || r(n.aoColumns[c].nTh).hasClass(e[o])) && f(c, h);
            if (u)
                for (s = 0, l = u.length; s < l; s++) f(s, u[s])
        }
        ...
        function pt(n) {
            ...
            return r.isPlainObject(n) ? (t = {}, r.each(n, function (n, i) {
                ...
                if (r !== "")
                    for (f = rr(r), e = 0, v = f.length; e < v; e++) {
        ...
        function ei(n, t, r, u) {
            ...
            if (r !== "dom" && (r && r !== "auto" || e.src !== "dom"))
                for (h = e.anCells, f = 0, o = h.length; f < o; f++) h[f].innerHTML = v(n, t, f, "display");
            else e._aData = oi(n, e.nTr).data;
            if (e._aSortData = null, e._aFilterData = null, s = n.aoColumns, u !== i) s[u].sType = null;
            else
                for (f = 0, o = s.length; f < o; f++) s[f].sType = null;
            or(e)
        }
        ...
        function lu(n) {
            ...
            if (o && wt(n.aoHeader, f), r(f).find(">tr").attr("role", "row"), r(f).find(">tr>th, >tr>td").addClass(s.sHeaderTH), r(a).find(">tr>th, >tr>td").addClass(s.sFooterTH), a !== null)
                for (c = n.aoFooter[0], i = 0, e = c.length; i < e; i++) t = h[i], t.nTf = c[i].cell, t.sClass && r(t.nTf).addClass(t.sClass)
        }
        ...
        function it(n) {
            ...
            if (h.length !== 0)
                for (it = o ? 0 : c, rt = o ? n.aoData.length : l, f = it; f < rt; f++) nt = h[f], t = n.aoData[nt], t.nTr === null && er(n, nt), a = t.nTr, g !== 0 && (v = d[w % g], t._sRowStripe != v && (r(a).removeClass(t._sRowStripe).addClass(v), t._sRowStripe = v)), s(n, "aoRowCallback", null, [a, t._aData, w, f]), p.push(a), w++;
        ...
        function au(n) {
            ...
            for (n.nTableWrapper = o[0], n.nTableReinsertBefore = n.nTable.nextSibling, c = n.sDom.split(""), e = 0; e < c.length; e++) {
                if (f = null, t = c[e], t == "<") {
                    ...
                    for (w = u.ext.feature, a = 0, k = w.length; a < k; a++)
                        if (t == w[a].cFeature) {
                            f = w[a].fnInit(n);
                            break
                        }
        ...
        function wt(n, t) {
            ...
            for (i = 0, h = c.length; i < h; i++)
                for (l = c[i], v = 0, u = l.firstChild; u;) {
                    if (u.nodeName.toUpperCase() == "TD" || u.nodeName.toUpperCase() == "TH")
                        for (f = u.getAttribute("colspan") * 1, e = u.getAttribute("rowspan") * 1, f = !f || f === 0 || f === 1 ? 1 : f, e = !e || e === 0 || e === 1 ? 1 : e, a = p(n, i, v), y = f === 1 ? !0 : !1, s = 0; s < f; s++)
                            for (o = 0; o < e; o++) n[i + o][a + s] = {
                                cell: u,
                                unique: y
                            }, n[i + o].nTr = l;
                    u = u.nextSibling
        ...
        function si(n, t, i) {
            var f = [],
                u, e, r, o;
            for (i || (i = n.aoHeader, t && (i = [], wt(i, t))), u = 0, e = i.length; u < e; u++)
        ...
        function bu(n) {
            for (var i, t, o, f, s, e = u.ext.search, h = ut(n, "bSearchable"), r = 0, c = e.length; r < c; r++)
                for (i = 0, t = 0, o = n.aiDisplay.length; t < o; t++) f = n.aiDisplay[t - i], s = e[r](n, cu(n, f, "filter", h), f), s || (n.aiDisplay.splice(t - i, 1), i++)
        }

        function ku(n, t, i, r, u, f) {
            var s, o, h, e;
            if (t !== "")
                for (o = n.aiDisplay, h = sr(t, r, u, f), e = o.length - 1; e >= 0; e--) s = n.aoData[o[e]]._aFilterData[i], h.test(s) || o.splice(e, 1)
        }
        ...
        function du(n, t, i, r, f, e) {
            ...
            if (u.ext.search.length !== 0 && (i = !0), l = nf(n), t.length <= 0) n.aiDisplay = c.slice();
                ...
                for ((l || i || h.length > t.length || t.indexOf(h) !== 0 || n.bSorted) && (n.aiDisplay = c.slice()), s = n.aiDisplay, o = s.length - 1; o >= 0; o--) a.test(n.aoData[s[o]]._sFilterRow) || s.splice(o, 1)
        }
        ...
        function ef(n) {
            ...
            return o || t.fnInit(n, i, s), f.p || (i.id = n.sTableId + "_paginate", n.aoDrawCallback.push({
                fn: function (n) {
                    if (o)
                        for (var l = n._iDisplayStart, r = n._iDisplayLength, a = n.fnRecordsDisplay(), u = r === -1, e = u ? 0 : Math.ceil(l / r), h = u ? 1 : Math.ceil(a / r), v = t(e, h), i = 0, c = f.p.length; i < c; i++) pr(n, "pageButton")(n, f.p[i], i, v, e, h);
                    else t.fnUpdate(n, s)
                },
                sName: "pagination"
            })), i
        ...
        function lr(t) {
            ...
            if (tt || l || g || w != vt(t) || w != h.length) {
                ...
                if (t.aoData.length)
                    for (i = 0; i < o.length; i++) b = o[i], u = s[b], r(af(t, b)).clone(!1).append(u.sContentPadding).appendTo(it);
                ...
                for (i = 0; i < w; i++) s[i].sWidth = e(h.eq(i).width());
            a && (c.style.width = e(a));
        ...
        function et(n) {
            ...
            for (r.isArray(t) && o(t), p && t.pre && o(t.pre), o(n.aaSorting), p && t.post && o(t.post), f = 0; f < i.length; f++)
                for (l = i[f][0], s = y[l].aDataSort, e = 0, a = s.length; e < a; e++) h = s[e], c = y[h].sType || "string", v.push({
                    src: l,
                    col: h,
                    dir: i[f][1],
                    index: i[f][2],
        ...
        var u, l, o, f, c, iu = /[\r\n]/g,
            ...
            p = function (n, t, r) {
                var f = [],
                    ...
                    e = n.length;
                if (r !== i)
                    for (; u < e; u++) n[u] && n[u][t] && f.push(n[u][t][r]);
                else
            ...
            ni = function (n, t, r, u) {
                var e = [],
                    ...
                    o = t.length;
                if (u !== i)
                    for (; f < o; f++) e.push(n[t[f]][r][u]);
                else
                    for (; f < o; f++) e.push(n[t[f]][r]);
                return e
            },
            ht = function (n, t) {
                var f = [],
        ...
        u = function (n) {
            ...
            return c && (n = {}), this.each(function () {
                ...
                if ((k === null || k === "") && (k = "DataTables_Table_" + u.ext._unique++, this.id = k), t = r.extend(!0, {}, u.models.oSettings, {
                    ...
                    })) !== -1 && (r("tbody tr", this).removeClass(rt.join(" ")), t.asDestroyStripes = rt.slice()), d = [], ct = this.getElementsByTagName("thead"), ct.length !== 0 && (wt(t.aoHeader, ct[0]), d = si(t)), e.aoColumns === null)
                    for (tt = [], o = 0, v = d.length; o < v; o++) tt.push(null);
                else tt = e.aoColumns;
                ...
                if (su(t, e.aoColumnDefs, tt, function (n, i) {
                    ...
                    })), e.bStateSave && (t.oFeatures.bStateSave = !0, df(t, e), y(t, "aoDrawCallback", pi, "state_save")), e.aaSorting === i)
                    for (o = 0, v = t.aaSorting.length; o < v; o++) t.aaSorting[o][1] = t.aoColumns[o].asSorting[0];
        ...
        u.Api = o = function (n, t) {
            ...
            if (i = [], f = function (n) {
                ...
                for (u = 0, e = n.length; u < e; u++) f(n[u]);
            else f(n);
            this.context = di(i);
        ...
        o.prototype = {
            ...
            iterator: function (n, t, r) {
                var e = [],
                    ...
                    y, a;
                for (typeof n == "string" && (r = t, t = n, n = !1), u = 0, p = s.length; u < p; u++)
                    if (t === "table") f = r(s[u], u), f !== i && e.push(f);
                    else if (t === "columns" || t === "rows") f = r(s[u], this[u], u), f !== i && e.push(f);
                else if (t === "column" || t === "column-rows" || t === "row" || t === "cell")
                    for (v = this[u], t === "column-rows" && (b = gr(s[u], l.opts)), h = 0, w = v.length; h < w; h++) c = v[h], f = t === "cell" ? r(s[u], c.row, c.column, u, h) : r(s[u], c, u, h, b), f !== i && e.push(f);
        ...
        var br = function (n, t) {
                var o = [],
                    e, f, i, s, u, h;
                for (r.isArray(n) || (n = [n]), i = 0, s = n.length; i < s; i++)
                    for (f = n[i] && n[i].split ? n[i].split(",") : [n[i]], u = 0, h = f.length; u < h; u++) e = t(typeof f[u] == "string" ? r.trim(f[u]) : f[u]), e && e.length && o.push.apply(o, e);
                return o
            },
            kr = function (n) {
            ...
            dr = function (n) {
                for (var t = 0, i = n.length; t < i; t++)
                    if (n[t].length > 0) return n[0] = n[t], n.length = 1, n.context = [n.context[t]], n;
                return n.length = 0, n
            },
            gr = function (n, t) {
                var i, e, h, u = [],
                    ...
                    l = t.page;
                if (l == "current")
                    for (i = n._iDisplayStart, e = n.fnDisplayEnd(); i < e; i++) u.push(o[i]);
                    ...
                    for (i = 0, e = n.aoData.length; i < e; i++) f == "none" ? u.push(i) : (h = r.inArray(i, o), (h === -1 && f == "removed" || h === 1 && f == "applied") && u.push(i));
                return u
            },
            le = function (n, t, i) {
        ...
        var ae = function (n, t, i, u) {
                ...
                if (r.isArray(i) || i instanceof r)
                    for (f = 0, s = i.length; f < s; f++) o(i[f], u);
                else o(i, u);
        ...
        var ye = /^(.*):(name|visIdx|visible)$/,
            ...
            we = function (n, t, u) {
                ...
                if (e.bVisible !== u) {
                    if (u)
                        for (v = r.inArray(!0, p(l, "bVisible"), t + 1), f = 0, a = o.length; f < a; f++) c = o[f].nTr, h = o[f].anCells, c && c.insertBefore(h[t], h[v] || null);
        ...
        return f("columns()", function (n, t) {
                ...
                return br(t, function (n) {
                    if (!n) {
                        for (s = [], f = 0, c = o.length; f < c; f++)
                            for (u = o[f], e = 0; e < v; e++) s.push({
                                row: u,
                                column: e
                            });
                        return s
                        ...
                        var h = n.oClasses,
                            ...
                            o, s, l = function (t, u) {
                                for (var p, a, b = function (t) {
                                    ...
                                    }, w, v = 0, y = u.length; v < y; v++)
                                    if (a = u[v], r.isArray(a)) w = r("<" + (a.DT_el || "div") + "/>").appendTo(t), l(w, a);
                                    else {
                                        o = "";
                                        s = "";
                                        switch (a) {
