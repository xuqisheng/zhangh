    ...
    var r = function (r) {
        ...
        return f.Client.prototype = {
                ...
                receiveEvent: function (i, r) {
                    ...
                    if (this.handlers[i])
                        for (e = 0, o = this.handlers[i].length; e < o; e++) u = this.handlers[i][e], typeof u == "function" ? u(this, r) : typeof u == "object" && u.length == 2 ? u[0][u[1]](this, r) : typeof u == "string" && n[u](this, r)
                }
            ...
            function (n, t, r) {
                ...
                u.prototype = {
                    fnGetSelected: function (n) {
                        var u = [],
                            ...
                            t, r;
                        if (n)
                            for (t = 0, r = f.length; t < r; t++) i[f[t]]._DTTT_selected && u.push(i[f[t]].nTr);
                        else
                            for (t = 0, r = i.length; t < r; t++) i[t]._DTTT_selected && u.push(i[t].nTr);
                        return u
                    },
                    ...
                    fnResizeRequired: function () {
                        var t, n;
                        for (t in f.clients)
                            if (t && (n = f.clients[t], typeof n.domElement != "undefined" && n.domElement.parentNode == this.dom.container && n.sized === !1)) return !0;
                        return !1
                    },
                    ...
                    _fnGetMasterSettings: function () {
                        ...
                        for (t = u._aInstances, n = 0, i = t.length; n < i; n++)
                            if (this.dom.table == t[n].s.dt.nTable) return t[n].s
                    },
                        ...
                        if (this.s.master) {
                            ...
                            n(i.nTBody).on("click.DTTT_Select", "tr", function (r) {
                                ...
                                if (this.parentNode == i.nTBody && i.oInstance.fnGetData(this) !== null) {
                                    if (f.type == "os")
                                        if (r.ctrlKey || r.metaKey) t.fnIsSelected(this) ? t._fnRowDeselect(this, r) : t._fnRowSelect(this, r);
                                        else if (r.shiftKey) {
                    ...
                    _fnColumnTargets: function (n) {
                        ...
                        if (typeof n == "object") {
                            ...
                            for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(r.aoColumns[t].bVisible ? !0 : !1);
                        else if (n == "hidden")
                            for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(r.aoColumns[t].bVisible ? !1 : !0);
                        else if (n == "sortable")
                            for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(r.aoColumns[t].bSortable ? !0 : !1);
                        else
                            for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(!0);
                        return u
                    },
                    ...
                    _fnGetDataTablesData: function (t) {
                        var r, e, o, b, f, s = [],
                            i = "",
                            a, u = this.s.dt,
                            v, l = new RegExp(t.sFieldBoundary, "g"),
                    ...
                    _fnPrintStart: function (i) {
                        ...
                        e = u.aanFeatures;
                        for (f in e)
                            if (f != "i" && f != "t" && f.length == 1)
                                for (o = 0, h = e[f].length; o < h; o++) this.dom.print.hidden.push({
                                    node: e[f][o],
                                    display: "block"
                ...
                u.fnGetInstance = function (n) {
                    ...
                    for (var t = 0, i = u._aInstances.length; t < i; t++)
                        if (u._aInstances[t].s.master && u._aInstances[t].dom.table == n) return u._aInstances[t];
                    return null
                };
