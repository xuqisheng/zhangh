...
select  hotel_group_id,
        ...
        (select min(c.biz_date)-interval 1 day  from audit_flag c where c.hotel_group_id=hotel.hotel_group_id and c.hotel_id=hotel.id ) as biz_date,
        (select a.day99 from rep_jie_history a
                         where a.hotel_group_id=hotel.hotel_group_id and a.hotel_id=hotel.id and
                               a.biz_date=(select min(c.biz_date)-interval 1 day  from audit_flag c where c.hotel_group_id=hotel.hotel_group_id and c.hotel_id=hotel.id ) and 
