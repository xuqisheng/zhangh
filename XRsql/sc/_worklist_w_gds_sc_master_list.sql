----------------------------------------------------------------------------------------------------
--	系统工作表 w_gds_sc_master_list : blocks 列表（base）
--
...
-- 删除所有相关 
----------------------------------------------------------------------------------------------------
delete  workselect 		where window='w_gds_sc_master_list';
delete  worksheet 		where window='w_gds_sc_master_list';
delete  workbutton_name where window='w_gds_sc_master_list' ;
delete  workbutton 		where window='w_gds_sc_master_list';
delete  worksta_name 	where window='w_gds_sc_master_list';
delete  worksta 		where window='w_gds_sc_master_list';
...
----------------------------------------------------------------------------------------------------
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_master','主单','Reservation','T','',10);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_profile','档案','Profile','T','',12);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_foact','关联主单','FO Resrv.','T','',15);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_sep1','','','T','',25);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_new','新建','New Group','T','',30);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_sep2','','','T','',45);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_rmgrid','客房占用','Room Grid','T','',50);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_activity','活动','Activities','T','',70);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_bill_res','打印单据','Print Folio','T','',80);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_note','备注','Notes','T','',90);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_sep3','','','T','',95);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_account','账务处理','Billing','F','---',100);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_fixchg','固定支出','Fixed charges','F','---',110);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_locksta','允许记账','Auth. Post','F','---',120);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_posting','入帐','Posting','F','---',130);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_routing','定义账户','Routing','F','---',140);
insert workbutton_name VALUES ('w_gds_sc_master_list','ue_bill_accnt','打印账单','Info Copy','F','---',150);
