drop proc p_report_yyjc09;
create proc p_report_yyjc09
...
insert into #type0 select deptno7 = '%' union all select distinct deptno7 from pccode where argcode<'98'
declare c_types cursor for select roomtype from #type0
declare c_rooms cursor for select isnull(rtrim(pccode),'***') from pccode where deptno7 like @type and argcode<'98'
...
while @@sqlstatus = 0
   ...
   update #roomtype set name0 = 'All Transactions',roomtype = 'all' where roomtype = '%'
   update #roomtype set name0 = 'Room Revenue' where roomtype = 'rm'
   update #roomtype set name0 = 'Food and Revenue'where roomtype = 'fb'
   update #roomtype set name0 = 'Meeting/Banquet' where roomtype = 'mt'
   update #roomtype set name0 = 'Other' where roomtype = 'ot'
   update #roomtype set name0 = 'Room Service' where roomtype = 'rs'
   --在此添加注释
