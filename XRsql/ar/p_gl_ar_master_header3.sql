...
if exists(select * from sysobjects where name = "p_gl_ar_master_header3")
	drop proc p_gl_ar_master_header3;

create proc p_gl_ar_master_header3
	@pc_id				char(4),
	@mdi_id				integer,
	@roomno				char(5),
	@accnt				char(10),
...
select @haccnt = haccnt from ar_master where accnt = @accnt
if @rmrate != @setrate
	begin
...
//
select @name1 = name from ar_master a, guest b where a.accnt = @groupno and a.haccnt *= b.no
