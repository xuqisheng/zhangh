...
if exists(select * from sysobjects where name = "p_gl_ar_master_header1")
	drop proc p_gl_ar_master_header1;

create proc p_gl_ar_master_header1
	@pc_id				char(4),
	@mdi_id				integer,
	@roomno				char(5),
	@accnt				char(10),
...
declare c_guest cursor for
	...
	from accnt_set a, ar_master b, guest c
