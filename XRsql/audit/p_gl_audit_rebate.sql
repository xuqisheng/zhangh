...
declare c_front cursor for 
	select a.accnt, a.number, a.charge, a.paycode from account_detail a, pccode b where a.paycode = b.pccode and not b.deptno8 in ('', '#')
open c_front
fetch c_front into @accnt, @number, @dcharge, @paycode
while @@sqlstatus = 0
	begin
	select @accnt = a.accnt, @pccode = a.pccode, @tag = a.tag, @charge = a.charge, @charge1 = a.charge1, @charge2 = a.charge2, 
		@charge3 = a.charge3, @charge4 = a.charge4, @charge5 = a.charge5, @roomno = a.roomno, @jierep = b.jierep, @tail = b.tail
		from outtemp a, pccode b where a.accnt = @accnt and a.number = @number and a.pccode = b.pccode
	if @dcharge = 0
		select @charge = 0, @charge1 = 0, @charge2 = 0, @charge3 = 0, @charge4 = 0, @charge5 = 0
	else if @dcharge != @charge
		begin
...
declare c_pos cursor for 
	select b.pccode, a.pccode, a.amount3, c.jierep, c.tail
		...
		where a.type = b.pccode and not b.deptno8 in ('', '#') and a.pccode = c.pccode and a.tocode = c.code
open c_pos
