...
//_com_p_协议单位业绩明细报表(按离日);
//(exec p_cq_master_income_cusno'#char08!请输入协议单位代码! #','#date1!请输入起始日期!#Bdate1##','#date2!请输入终止日期!#Bdate1##'resultset=char61,char07,char12, char60, mone10_1, mone10_2, mone10_3, mone10_5, mone10_6, mone10_7, mone10_8,mone10_9);
...
//computes=c_g0:'协议单位---'+nodispchar61:header:4::char12:mone10_9::alignment="0" border="0"!
...
//texttext=t_title1:协 议 单 位 业 绩 明 细 报 告 (按离日):header:2::char12:mone10_9::border="0" alignment="2" font.height="-12" font.italic="1"!
//texttext=t_title2:<#date1#-#date2#>:header:3::char12:mone10_9::border="0" alignment="2" font.height="-12" font.italic="1"!
//texttext=t_dte:协议单位 === nodispchar61:header:4::char12:mone10_2::alignment="0" border="0"! 
