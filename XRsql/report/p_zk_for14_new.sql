...
//去年统计
update #temp set rm = (select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon1s and bdate <=@lmon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev=(select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon1s and bdate <=@lmon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='1'
update #temp set rm = rm +(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon1s and bdate <=@lmon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev = rev +(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon1s and bdate <=@lmon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='1'
update #temp set rm = (select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon2s and bdate <=@lmon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev = (select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon2s and bdate <=@lmon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='2'
update #temp set rm = rm +(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon2s and bdate <=@lmon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev = rev +(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon2s and bdate <=@lmon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='2'
update #temp set rm = (select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon3s and bdate <=@lmon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = (select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon3s and bdate <=@lmon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='3'
update #temp set rm = rm+(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon3s and bdate <=@lmon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = rev+(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lmon3s and bdate <=@lmon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='3'
update #temp set rm = rm+(select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lys and bdate <=@lye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = rev+(select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lys and bdate <=@lye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='y'
update #temp set rm = rm+(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lys and bdate <=@lye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = rev+(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@lys and bdate <=@lye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='y'
//今年统计
update #temp set rm = (select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon1s and bdate <=@mon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev=(select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon1s and bdate <=@mon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='4'
update #temp set rm = rm +(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon1s and bdate <=@mon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev = rev +(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon1s and bdate <=@mon1e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='4'
update #temp set rm = (select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon2s and bdate <=@mon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev = (select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon2s and bdate <=@mon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='5'
update #temp set rm = rm +(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon2s and bdate <=@mon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%'))
					, rev = rev +(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon2s and bdate <=@mon2e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='5'
update #temp set rm = (select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon3s and bdate <=@mon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = (select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon3s and bdate <=@mon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='6'
update #temp set rm = rm+(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon3s and bdate <=@mon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = rev+(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@mon3s and bdate <=@mon3e  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='6'
update #temp set rm = rm+(select isnull(sum(quantity),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@ys and bdate <=@ye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = rev+(select isnull(sum(charge),0) from account where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@ys and bdate <=@ye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='z'
update #temp set rm = rm+(select isnull(sum(quantity),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@ys and bdate <=@ye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) 
					, rev = rev+(select isnull(sum(charge),0) from haccount where (substring(mode,1,1) in ('J','j','P','N','B','b')) and substring(mode,2,1)>='0' and  substring(mode,2,1)<='9'  and bdate >=@ys and bdate <=@ye  and tag=#temp.mkt and roomno in (select roomno from rmsta where charindex(rtrim(type),@type)>0 or @type='%')) where dd='z'
