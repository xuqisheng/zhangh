...
IF OBJECT_ID('p_gds_salesrep1_rmtype_class_g') IS NOT NULL
    DROP PROCEDURE p_gds_salesrep1_rmtype_class_g
;
create proc p_gds_salesrep1_rmtype_class_g
	@cusno      varchar(10),
	@rmtype		varchar(5),
	@begin_		datetime,
	@end_			datetime
...
begin
	insert #gout
		select b.cusno,'',c.code, c.descript, b.accnt, b.t_arr, b.master, b.rm, b.gstno, b.i_days
	...
	insert #gout
		select b.agent,'',c.code, c.descript, b.accnt, b.t_arr, b.master, b.rm, b.gstno, b.i_days
			From typim a, ycus_xf b, gtype c 
			Where (c.code = @rmtype or @rmtype='%') 
					and a.type = b.type and a.gtype=c.code 
	...
	insert #gout
		select b.source,'',c.code, c.descript, b.accnt, b.t_arr, b.master, b.rm, b.gstno, b.i_days
			From typim a, ycus_xf b, gtype c 
			Where (c.code = @rmtype or @rmtype='%') 
					and a.type = b.type and a.gtype=c.code 
