...
DROP PROCEDURE IF EXISTS `up_ihotel_up_master_r`$$

CREATE DEFINER=`root`@`%` PROCEDURE `up_ihotel_up_master_r`(
...
BEGIN
	...
	DECLARE c_master CURSOR FOR 
		SELECT a.accnt,b.no,a.type,a.roomno,a.rmnum,a.arr,a.dep,a.cusno,a.agent,a.source,a.cardcode,a.cardno,a.saleid,TRIM(b.name),IF(b.nation IN('CN','TW'),TRIM(b.fname),TRIM(b.lname)),IF(b.nation IN('CN','TW'),TRIM(b.lname),TRIM(b.fname)),TRIM(b.name2),TRIM(b.name3),
			...
			IF(b.birth >= DATE_ADD(NOW(),INTERVAL -1 DAY),NULL,birth),b.vip,b.idcls,b.ident,b.nation,b.race,TRIM(b.street),b.city,a.extra,a.charge-a.credit,b.i_times,a.changed,a.phone,a.fax,a.email,b.feature,
		...
		FROM migrate_db.master a,migrate_db.guest b WHERE a.haccnt=b.no AND a.class IN ('F','G','M') AND a.sta='R' ORDER BY a.accnt;
	...
	FETCH c_master INTO var_accnt,var_guestid,var_rmtype,var_rmno,var_rmnum,var_arr,var_dep,var_cusno,var_agent,var_source,var_cardcode,var_cardno,var_saleid,var_name,var_lname,var_fname,var_name2,var_name3,
					...
					var_birth,var_vip,var_idcls,var_ident,var_nation,var_race,var_address,var_birthplace,var_extra,var_balance,var_itimes,var_changed,var_phone,var_fax,var_email,var_feature,
	...
	WHILE done_cursor = 0 DO
		BEGIN
			...
			IF var_profile_id = 0 AND var_ident <> '' THEN 
				...
				CALL ihotel_up_get_guest_id(arg_hotel_group_id,arg_hotel_id,var_haccnt,var_name,var_idcls,var_ident,var_sex,var_birth,var_race,var_address,var_birthplace,var_profile_id); 					
			END IF; 
			...
			IF var_accnt = var_last_accnt THEN 				
				...
				VALUES(arg_hotel_group_id,arg_hotel_id,0,IF(var_rmno<>'','F','T'),var_applname,var_applicant,0,var_class,0,0,0,var_biz_date,
			...
			IF var_profile_id > 0 THEN 
				...
				SELECT arg_hotel_group_id,arg_hotel_id,var_id,'GUEST',a.id,var_itimes,a.name,a.last_name,a.first_name,a.name2,a.name3,a.name_combine,
					...
					var_vip,'',var_phone,var_fax,var_email,a.id_code,a.id_no,a.id_end,var_visaid,'',NULL,var_visaend,'',var_rjplace,var_rjdate,NULL,
			...
			ELSE
				...
				VALUES(arg_hotel_group_id,arg_hotel_id,var_id,'GUEST',0,var_itimes,var_name,var_lname,var_fname,var_name2,var_name3,CONCAT(var_name,var_name2),
					...
					var_vip,'',var_phone,var_fax,var_email,var_idcls,var_ident,NULL,var_visaid,'',NULL,var_visaend,'',var_rjplace,var_rjdate,NULL,
					0,0,'','',var_feature,var_cby,var_changed,var_cby,var_changed);
			END IF; 			
			-- master_stalog 状态信息
