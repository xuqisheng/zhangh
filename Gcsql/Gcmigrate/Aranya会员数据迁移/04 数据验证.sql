...
FROM (
	...
	WHERE cb.hotel_group_id=2  AND cb.hotel_id = 0 AND cb.create_datetime < ADDDATE(DATE('2017-5-10'),INTERVAL 1 DAY)
	...
	WHERE cb.hotel_group_id=2  AND cb.hotel_id = 0 AND cp.biz_date <= '2017-5-10'
...
LEFT JOIN (
	...
	WHERE cb.hotel_group_id=2  AND cb.hotel_id = 0 AND ca.biz_date <= '2017-5-10'
