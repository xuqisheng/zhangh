CREATE TABLE aranya_member_data (
  ...
  guest_id 			bigint(20) DEFAULT NULL COMMENT '若有超哥导好的客史档案，根据hno填写该值',
  ...
  araccnt 			varchar(100) DEFAULT NULL COMMENT '原系统账务账号，如AR账号',
  ...
  KEY index2 (card_no2),
  KEY index3 (card_id_temp),
  KEY index4 (member_id_temp),
  KEY index5 (guest_id),
  KEY index6 (card_id),
  KEY index7 (hno),
  KEY index8 (hotel_group_id,hotel_id)
