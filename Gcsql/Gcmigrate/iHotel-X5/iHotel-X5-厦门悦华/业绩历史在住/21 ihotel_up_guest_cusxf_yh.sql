...
AND a.accnt NOT LIKE 'AR%'
	...
	*/
	...
	FROM migrate_xmyh.ycus_xf WHERE tag = 'A' AND DATE <='2014.12.6' AND actcls='F' AND accnt LIKE 'F%';
	...
	SELECT arg_hotel_group_id,arg_hotel_id,DATE,'master',accnt_id,master_id,groupno_id,'','I',
		...
		i_days,i_days,x_times,n_times,0,0,0,
		rm,0,0,0,0,0,fb,0,en,sp,ot,ttl
	FROM migrate_xmyh.ycus_xf WHERE tag = 'A' AND DATE <='2014.12.6' AND  actcls='F' AND accnt LIKE 'G%';
	...
	SELECT arg_hotel_group_id,arg_hotel_id,DATE,'master',accnt_id,master_id,groupno_id,'','I',
		...
		i_days,i_days,x_times,n_times,0,0,0,
		rm,0,0,0,0,0,fb,0,en,sp,ot,ttl
	FROM migrate_xmyh.ycus_xf WHERE tag = 'A' AND DATE <='2014.12.6' AND  actcls='F' AND accnt LIKE 'M%';	
	...
	SELECT arg_hotel_group_id,arg_hotel_id,DATE,'armaster',accnt_id,master_id,groupno_id,'','I',
		...
		i_days,i_days,x_times,n_times,0,0,0,
		rm,0,0,0,0,0,fb,0,en,sp,ot,ttl
	FROM migrate_xmyh.ycus_xf WHERE tag = 'A' AND DATE <='2014.12.6' AND actcls='F' AND accnt LIKE 'AR%';
	...
	SELECT arg_hotel_group_id,arg_hotel_id,DATE,'consume',accnt_id,master_id,groupno_id,'','I',
		...
		i_days,i_days,x_times,n_times,0,0,0,
		rm,0,0,0,0,0,fb,0,en,sp,ot,ttl
	FROM migrate_xmyh.ycus_xf WHERE tag = 'A' AND DATE <='2014.12.6' AND actcls='F' AND accnt LIKE 'C%';
	...
	SELECT arg_hotel_group_id,arg_hotel_id,DATE,'pos',accnt_id,master_id,groupno_id,'','I',
		...
		i_days,i_days,x_times,n_times,0,0,0,
		rm,0,0,0,0,0,fb,0,en,sp,ot,ttl
	FROM migrate_xmyh.ycus_xf WHERE tag = 'A' AND DATE <='2014.12.6' AND actcls='P';
	...
	AND a.accnt=b.id AND a.biz_date<='2014-12-06';
	...
	WHERE a.hotel_group_id=arg_hotel_group_id AND a.hotel_id=arg_hotel_id AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id
	AND a.accnt=b.id AND a.biz_date<='2014-02-06';	
