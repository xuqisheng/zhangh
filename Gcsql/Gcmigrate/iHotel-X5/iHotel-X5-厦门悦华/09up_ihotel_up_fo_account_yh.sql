...
DROP PROCEDURE IF EXISTS `up_ihotel_up_fo_account_yh`$$

CREATE DEFINER=`root`@`%` PROCEDURE `up_ihotel_up_fo_account_yh`(
...
BEGIN
	...
	SELECT b.hotel_group_id,b.hotel_id,b.accnt_new,0,a.number,a.inumber,'02',a.bdate,a.date,a.pccode,
			...
			a.ref,a.ref,a.ref1,a.ref2,a.roomno,a.groupno,a.mode,IF(a.billno='','',SUBSTR(a.billno,1,1)),IF(a.billno='',NULL,'-1'),a.package,'',NULL,
