...
SELECT * FROM rep_revenue_type WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date = '2014.11.14'
...
DELETE FROM rep_revenue_type_history WHERE hotel_id = 1;
...
SELECT hotel_group_id, 
	...
	people_arr, 
	people_dep
FROM rep_revenue_type WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date >= '2013.1.1'

DELETE FROM rep_revenue_type WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date <='2014.11.25'