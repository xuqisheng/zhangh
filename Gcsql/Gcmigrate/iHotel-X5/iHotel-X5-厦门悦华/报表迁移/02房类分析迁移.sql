...
SELECT * FROM migrate_xmyh.yrmsalerep_new ;
...
SELECT * FROM migrate_xmyh.yrmsalerep_new  WHERE DATE = '2013.1.1';
SELECT * FROM up_map_code WHERE hotel_id = 1 AND CODE = 'building';
SELECT * FROM code_base WHERE hotel_id = 1 AND parent_code = 'building';
UPDATE migrate_xmyh.yrmsalerep_new a,up_map_code b SET a.hall = b.code_new 
WHERE b.hotel_group_id = 1 AND b.hotel_id = 1 AND b.code = 'building' AND b.code_old = a.hall AND DATE = '2013.1.2';
-- 扩充先关字段
UPDATE migrate_xmyh.rmsalerep_new a,up_map_code b SET a.hall = b.code_new 
...
DELETE FROM  rep_rmsale WHERE hotel_group_id = 1 AND hotel_id = 1;
DELETE FROM  rep_rmsale_history WHERE hotel_group_id = 1 AND hotel_id = 1;
...
DELETE FROM rep_rmsale_history WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date <='2014.12.07';
INSERT INTO rep_rmsale_history SELECT * FROM rep_rmsale WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date <='2014.12.07';
DELETE FROM rep_rmsale WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date < '2014.12.07';
SELECT DISTINCT biz_date FROM rep_rmsale WHERE hotel_group_id = 1 AND hotel_id = 1 
SELECT * FROM rep_rmsale WHERE hotel_group_id = 1 AND hotel_id = 1 

SELECT rep_type,building,CODE,descript,rooms_vac,sold_fit,sold_grp,sold_long,sold_ent FROM rep_rmsale_history WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date ='2014.12.07';
