...
DROP PROCEDURE IF EXISTS `ihotel_up_code_maint`$$

CREATE DEFINER=`root`@`%` PROCEDURE `ihotel_up_code_maint`(
...
BEGIN
	...
	UPDATE master_base SET market = 'LYSK01' WHERE hotel_group_id=arg_hotel_group_id AND hotel_id = arg_hotel_id AND market = '';
	UPDATE master_base SET src = 'XX' WHERE hotel_group_id=arg_hotel_group_id AND hotel_id = arg_hotel_id AND src = '';
    ...
    UPDATE master_base SET dsc_reason = '002' WHERE hotel_group_id = arg_hotel_group_id AND hotel_id = arg_hotel_id AND rack_rate <> real_rate ;	
	-- 修复打开团队主单账务时报错	
	...
	*/	
	...
	-- 横店特殊处理
	UPDATE account SET ta_code = '9002' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9005';
	UPDATE account SET ta_code = '9003' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9006';
	UPDATE ar_account SET ta_code = '9002' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9005';
	UPDATE ar_account SET ta_code = '9003' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9006';
	UPDATE ar_detail SET ta_code = '9002' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9005';
	UPDATE ar_detail SET ta_code = '9003' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9006';	

	UPDATE account SET ta_code = '9555' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9770';
	UPDATE account SET ta_code = '9555' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9770';
	UPDATE ar_account SET ta_code = '9555' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9770';
	UPDATE ar_account SET ta_code = '9555' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9770';
	UPDATE ar_detail SET ta_code = '9555' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9770';
	UPDATE ar_detail SET ta_code = '9555' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9770';	

	UPDATE account SET ta_code = '9800' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9880';
	UPDATE account SET ta_code = '9800' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9880';
	UPDATE ar_account SET ta_code = '9800' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9880';
	UPDATE ar_account SET ta_code = '9800' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9880';
	UPDATE ar_detail SET ta_code = '9800' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9880';
	UPDATE ar_detail SET ta_code = '9800' WHERE hotel_group_id =arg_hotel_group_id AND hotel_id=arg_hotel_id AND ta_code='9880';	
