...
SELECT hotel_group_id, 
	...
	people_arr, 
	people_dep
FROM rep_revenue_type WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date <= '2014.10.29'

DELETE FROM rep_revenue_type WHERE hotel_group_id = 1 AND hotel_id = 1 AND biz_date < '2014.10.24'