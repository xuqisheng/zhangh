...
BEGIN
	...
	IF arg_type = 'H' THEN
		BEGIN
			...
			*/			
			...
			UPDATE grp_sales_detail a,code_base b SET a.classdesc=b.descript WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.biz_date = var_bdate AND a.type='MARKET' AND b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = 0 AND b.parent_code ='market_category' AND a.class=b.code;
			...
			UPDATE grp_sales_detail a,code_base b SET a.classdesc=b.descript WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.biz_date = var_bdate AND a.type='SOURCE' AND b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = 0 AND b.parent_code ='src_cat' AND a.class=b.code;	
			...
			UPDATE grp_sales_detail SET class=section,classdesc=sectiondesc WHERE hotel_group_id = arg_hotel_group_id AND hotel_id = arg_hotel_id AND biz_date = var_bdate AND type='CHANNEL';
			...
			UPDATE grp_sales_detail SET class=section,classdesc=sectiondesc WHERE hotel_group_id = arg_hotel_group_id AND hotel_id = arg_hotel_id AND biz_date = var_bdate AND type='RESTYPE';
			
			-- 房价码更新
			UPDATE grp_sales_detail a,code_ratecode b SET a.sectiondesc=b.descript,a.class=b.category WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.biz_date = var_bdate AND a.type='RATECODE' AND b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND a.section=b.code;	
			UPDATE grp_sales_detail a,code_base b SET a.classdesc=b.descript WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.biz_date = var_bdate AND a.type='RATECODE' AND b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = 0 AND b.parent_code ='ratecode_categroy' AND a.class=b.code;	
	...
	IF arg_type = 'G' THEN
		BEGIN
			...
			DELETE FROM grp_sales_detail WHERE hotel_group_id = arg_hotel_group_id AND hotel_id = arg_hotel_id AND biz_date = var_bdate;			
			INSERT INTO grp_sales_detail(hotel_group_id,hotel_id,biz_date,type,class,classdesc,section,sectiondesc,income,nights,persons)
			SELECT hotel_group_id,arg_hotel_id,biz_date,type,class,classdesc,section,sectiondesc,SUM(income),SUM(nights),SUM(persons) FROM grp_sales_detail WHERE hotel_group_id = arg_hotel_group_id AND biz_date = var_bdate GROUP BY type,class,biz_date;
