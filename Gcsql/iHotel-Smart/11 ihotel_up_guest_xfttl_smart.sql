...
DROP PROCEDURE IF EXISTS `ihotel_up_guest_xfttl_smart`$$

CREATE DEFINER=`root`@`%` PROCEDURE `ihotel_up_guest_xfttl_smart`(
...
BEGIN
	...
	SELECT b.hotel_group_id,b.hotel_id,a.year,TRIM(a.tag),b.accnt_class,b.accnt_new,a.m1,a.m2,a.m3,a.m4,a.m5,a.m6,a.m7,a.m8,a.m9,a.m10,a.m11,a.m12,a.ttl 
		FROM migrate_yl.guest_xfttl a,up_map_accnt b 
