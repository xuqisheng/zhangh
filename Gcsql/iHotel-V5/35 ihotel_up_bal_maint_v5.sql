...
DROP PROCEDURE IF EXISTS `ihotel_up_bal_maint_v5`$$

CREATE DEFINER=`root`@`%` PROCEDURE `ihotel_up_bal_maint_v5`(
...
label_0:
   ...
   ================================*/
   /*
	INSERT INTO master_snapshot_msg SELECT * FROM master_snapshot WHERE hotel_group_id=1 AND hotel_id=105 AND biz_date='2014-8-12';
	INSERT INTO rep_dai_msg SELECT * FROM rep_dai WHERE hotel_group_id=1 AND hotel_id=105 AND biz_date='2014-8-12';
	INSERT INTO rep_jiedai_msg SELECT * FROM rep_jiedai WHERE hotel_group_id=1 AND hotel_id=105 AND biz_date='2014-8-12';
...
AND biz_date_begin < '2015.01.06'
AND biz_date_end >= '2015.01.06'
