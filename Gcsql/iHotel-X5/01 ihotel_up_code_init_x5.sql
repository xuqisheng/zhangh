...
BEGIN
	...
	UPDATE migrate_db.guest SET saleid ='' WHERE class = 'F' AND salei<>'';
	UPDATE migrate_db.guest SET belong ='1,3,K' WHERE belong='';
	UPDATE migrate_db.guest a,up_map_code b SET a.idcls = b.code_new WHERE b.cat = 'idcode' AND a.idcls = b.code_old AND b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id;
	-- UPDATE migrate_db.guest a,up_map_code b SET a.nation = b.code_new WHERE b.cat = 'nation'  AND a.nation = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	-- UPDATE migrate_db.guest a,up_map_code b SET a.country= b.code_new WHERE b.cat = 'country' AND a.nation = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.guest a,up_map_code b SET a.saleid = b.code_new WHERE b.cat = 'salesman' AND a.saleid = b.code_old AND a.saleid<>'' AND b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id;
	UPDATE migrate_db.guest a,up_map_code b SET a.src 		= b.code_new WHERE b.cat = 'srccode'  AND a.src = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.guest a,up_map_code b SET a.market 	= b.code_new WHERE b.cat = 'mktcode'  AND a.market = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.guest a,up_map_code b SET a.code1 	= b.code_new WHERE b.cat = 'ratecode' AND a.code1 = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	
	UPDATE migrate_db.master a,up_map_code b SET a.src 		= b.code_new WHERE b.cat = 'srccode'  AND a.src = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.master a,up_map_code b SET a.market 	= b.code_new WHERE b.cat = 'mktcode'  AND a.market = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.master a,up_map_code b SET a.restype 	= b.code_new WHERE b.cat = 'restype'  AND a.restype = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.master a,up_map_code b SET a.channel 	= b.code_new WHERE b.cat = 'channel'  AND a.channel = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.master a,up_map_code b SET a.ratecode = b.code_new WHERE b.cat = 'ratecode' AND a.ratecode = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.master a,up_map_code b SET a.paycode 	= b.code_new WHERE b.cat = 'paymth'   AND a.paycode = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.master a,up_map_code b SET a.saleid 	= b.code_new WHERE b.cat = 'salesman' AND a.saleid = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	
	UPDATE migrate_db.rsvsrc a,up_map_code b SET a.src 		= b.code_new WHERE b.cat = 'srccode'  AND a.src = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.rsvsrc a,up_map_code b SET a.market 	= b.code_new WHERE b.cat = 'mktcode'  AND a.market = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
	UPDATE migrate_db.rsvsrc a,up_map_code b SET a.ratecode = b.code_new WHERE b.cat = 'ratecode' AND a.ratecode = b.code_old AND b.hotel_group_id=arg_hotel_group_id AND b.hotel_id=arg_hotel_id;
