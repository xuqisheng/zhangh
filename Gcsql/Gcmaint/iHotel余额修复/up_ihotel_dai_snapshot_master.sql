...
DROP PROCEDURE IF EXISTS `up_ihotel_dai_snapshot_master`$$

CREATE DEFINER=`root`@`%` PROCEDURE `up_ihotel_dai_snapshot_master`(
...
CALL up_ihotel_dai_snapshot_master(2,18);
