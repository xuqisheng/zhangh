...
BEGIN
	...
	*/
    ...
    UPDATE master_base SET dsc_reason = 'O02' WHERE hotel_group_id = arg_hotel_group_id AND hotel_id = arg_hotel_id AND rack_rate <> real_rate ;	
	-- 修复打开团队主单账务时报错	
	...
	-- 在主单界面显示原账号	| 手工编号
	UPDATE master_base SET credit_man = sc_flag WHERE hotel_group_id = arg_hotel_group_id AND hotel_id = arg_hotel_id AND sc_flag <> '';
