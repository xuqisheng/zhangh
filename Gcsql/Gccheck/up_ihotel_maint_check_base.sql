...
BEGIN
	...
	-- 	AND (a.sales_group IS NULL OR NOT EXISTS(SELECT 1 FROM sales_group b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND a.sales_group=b.code));
 	INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('code_ratecode:',a.code,' 房价码定义:包含无效的市场码 ',a.market) FROM code_ratecode a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id
 	...
 	INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('code_ratecode:',a.code,' 房价码定义:包含无效的来源码 ',a.market) FROM code_ratecode a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id
	...
	IF var_client_version = 'IHOTEL' THEN
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=real_room_sta_report_code ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='report' AND a.item='real_room_sta_report_code'
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=room_sta_report_code ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='report' AND a.item='room_sta_report_code'
			AND NOT EXISTS(SELECT 1 FROM report_center b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.code=a.set_value);
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=rep_night_charge ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='audit' AND a.item='rep_night_charge'
		...
		INSERT INTO tmp_check_base SELECT NULL,'B',CONCAT('sys_option: item=balance_transfer_ta_code ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='balance_transfer_ta_code'
	...
	ELSEIF (var_client_version='THEF' OR var_client_version='THEK') THEN
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=accredit_default_code ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='accredit_default_code'
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=business_accnt 现付帐 ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='business_accnt' AND a.set_value <> ''
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=check_default_in_code ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='check_default_in_code'
			AND NOT EXISTS(SELECT 1 FROM code_transaction b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.arrange_code>'9' AND b.code=a.set_value);
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=check_default_out_code ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='check_default_out_code'
			AND NOT EXISTS(SELECT 1 FROM code_transaction b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.arrange_code>'9' AND b.code=a.set_value);
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=cash_default_code ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='cash_default_code'
			AND NOT EXISTS(SELECT 1 FROM code_transaction b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.arrange_code>'9' AND b.code=a.set_value);
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_rmtype ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_rmtype'
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_market ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_market'
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_src ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_src'
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_channel ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_channel'
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_hourmarket ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_hourmarket'
			AND NOT EXISTS(SELECT 1 FROM code_base b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.parent_code='market_code' AND b.code=a.set_value);
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_code_rate ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_code_rate'
		...
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_dayuse_ratecode ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_dayuse_ratecode'
			AND NOT EXISTS(SELECT 1 FROM code_ratecode b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.code=a.set_value AND b.is_halt='F');
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_free_rate ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item='default_free_rate'
			AND NOT EXISTS(SELECT 1 FROM code_ratecode b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.code=a.set_value AND b.is_halt='F');
		
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_ratecode_c ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='walkin' AND a.item = 'default_ratecode_c'
			AND NOT EXISTS(SELECT 1 FROM code_ratecode b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.code=a.set_value AND b.is_halt='F');
		-- 预订业务 默认市场码
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_src ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='reserve' AND a.item = 'default_src'
			AND NOT EXISTS(SELECT 1 FROM code_base b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.parent_code='src_code' AND b.code=a.set_value);
		INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=default_channel ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='reserve' AND a.item = 'default_channel'
			AND NOT EXISTS(SELECT 1 FROM code_base b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.parent_code='channel' AND b.code=a.set_value);
	...
	END IF;
	-- 参数检查
 	INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=ta_code_for_room_night ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='audit' AND a.item='ta_code_for_room_night'
		AND NOT EXISTS(SELECT 1 FROM code_transaction b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND a.set_value=b.code);
	...
	IF EXISTS (SELECT 1 FROM master_base WHERE hotel_group_id = arg_hotel_group_id AND hotel_id = arg_hotel_id AND rsv_class='H' AND sta='I') THEN
		INSERT INTO tmp_check_base SELECT NULL,'B',CONCAT('sys_option: item=roomAccnt_accnt ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='roomAccnt_accnt'
				AND NOT EXISTS(SELECT 1 FROM master_base b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND b.rsv_class='H' AND b.id=a.set_value);
	END IF;

 	INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=day_use_tacode ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='day_use_tacode'
		AND NOT EXISTS(SELECT 1 FROM code_transaction b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND a.set_value=b.code);
 	...
 	INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT('sys_option: item=round_ta_pccode ',a.descript,' ',a.set_value,' 不存在') FROM sys_option a WHERE a.hotel_group_id = arg_hotel_group_id AND a.hotel_id = arg_hotel_id AND a.catalog='account' AND a.item='round_ta_pccode'
		AND NOT EXISTS(SELECT 1 FROM code_transaction b WHERE b.hotel_group_id = arg_hotel_group_id AND b.hotel_id = arg_hotel_id AND a.set_value=b.code);
    ...
    INSERT INTO tmp_check_base SELECT NULL,'A',CONCAT("餐饮接口配置表营业点配置遗漏: ",code,' ',descript)
		FROM pos_pccode WHERE hotel_group_id=arg_hotel_group_id AND hotel_id=arg_hotel_id AND CODE NOT IN 
			(SELECT pos_code FROM pos_interface_map WHERE hotel_group_id=arg_hotel_group_id AND hotel_id=arg_hotel_id AND link_type='ta_code');	 	
